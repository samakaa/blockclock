defmodule BlockClock.Store do
  ...
  @impl true
  def handle_cast(%{set_lflux: result}, state) do


    broadcastflux(:set_lflux, result)

    {:noreply, result}
  end

  defp broadcastflux(:set_lflux, result) do
    Phoenix.PubSub.broadcast(PubSub, "result", {:set_lflux, result})
  end
